...
var buffer_1 = require("../buffer"), error_1 = require("../../driver/error"), const_1 = require("../../desc/const"), events_1 = require("events"), timer_1 = require("../../utils/timer"), svcConf_1 = require("../../desc/svcConf"), Msg = function(_) {
    function M(t, s, i, n) {
        var r = _.call(this) || this;
        return r.br = t, r.St = new buffer_1.DmBuffer(M.Cs), r.fr = s, r.fs = 0, r.dr = i, 
        r._callback = n, r._timeout = t.pt.conn_prop_socketTimeout, r._timer = new timer_1.Timer(function() {
            r.emit("timeout");
        }), r;
    }
    return __extends(M, _), M.prototype.Kt = function() {
        this.emit("packet", this.St.tn);
    }, M.prototype.Y = function(t) {
        var s = void 0, i = null;
        try {
            if (t) throw t;
            s = this.Ds();
        ...
        this.Es(), this.te(), this.Ts();
    }, M.prototype.Es = function() {
        this.St.Tt(0), this.St.rn(M.kt, !0, !0);
    }, M.prototype.Ts = function() {
        this.St.f(M.As, this.dr ? this.dr.handle : 0), this.St.B(M.Lt, this.fr), this.St.f(M.en, this.St.Gt - M.kt);
